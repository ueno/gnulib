  ...
  for (;;)
    {
      ...
      char value3[200+1];
      char *joining_type_name;
      char *joining_group_name;
      int joining_type;
      int joining_group;
      ...
      if (sscanf (buf, "%X%[;]%[^;]%[;]%[^;]%[;]%100[^\n]",
                  &i, separator1, value1, separator2, value2,
                  separator3, value3) != 7)
        {
      ...
      joining_type_name = strip_whitespace (value2);
      joining_group_name = strip_whitespace (value3);
